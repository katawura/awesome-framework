 ...
 * 
 * Plugin Name: Awesome_Widget_Business_Hours
 * Plugin URI: http://www.newwebdevelopers.net
 * Description: A widget that displays business hours.
 * Version: 1.0
 * Author: Kelvin Atawura
 * Author URI: http://www.kelvinatawura.co.uk
*/

class Awesome_Widget_Business_Hours extends WP_Widget {
	...
	public function __construct() {
		parent::__construct( 
			...
			__( 'Awesome: Business Hours', 'alpha' ),
			array(
				'classname'   => 'widget-business-hours',
				'description' => __( 'A custom widget that displays business hours.', 'awesome' )
			) 
		);
	}
	...
	public function form( $instance ) {
		...
		<!-- Description -->
		<p>
			<label for="<?php echo $this->get_field_id( 'hours_description' ); ?>"><?php _e( 'Description:', 'awesome' ); ?></label>
		...
		<!-- Monday-Friday -->
		<p>
			<label for="<?php echo $this->get_field_id( 'hours_monday_friday' ); ?>"><?php _e( 'Monday-Friday:', 'awesome' ); ?></label>
		...
		<!-- Saturday -->
		<p>
			<label for="<?php echo $this->get_field_id( 'hours_saturday' ); ?>"><?php _e( 'Saturday:', 'awesome' ); ?></label>
		...
		<!-- Sunday -->
		<p>
			<label for="<?php echo $this->get_field_id( 'hours_sunday' ); ?>"><?php _e( 'Sunday:', 'awesome' ); ?></label>
...
add_action( 'widgets_init', create_function( '', 'register_widget( "Awesome_Widget_Business_Hours" );' ) );
?>